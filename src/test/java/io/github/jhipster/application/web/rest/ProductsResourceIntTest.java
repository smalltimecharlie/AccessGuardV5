...
public class ProductsResourceIntTest {
    ...
    public void createProducts() throws Exception {
        ...
        assertThat(testProducts.getProductUrl()).isEqualTo(DEFAULT_PRODUCT_URL);
    }
    ...
    @Test
    @Transactional
    public void checkProductUrlIsRequired() throws Exception {
        int databaseSizeBeforeTest = productsRepository.findAll().size();
        // set the field null
        products.setProductUrl(null);
    ...
    public void updateProducts() throws Exception {
        ...
        assertThat(testProducts.getProductUrl()).isEqualTo(UPDATED_PRODUCT_URL);
    }
