...
describe('Service Tests', () => {
    describe('LocationType Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(LocationTypeService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new LocationType(0, 'AAAAAAA', false);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should update a LocationType', async () => {
                const returnedFromService = Object.assign(
                    {
                        locationTypeName: 'BBBBBB',
                        active: true
                    },
                    elemDefault
                );
            ...
            it('should return a list of LocationType', async () => {
                const returnedFromService = Object.assign(
                    {
                        locationTypeName: 'BBBBBB',
                        active: true
